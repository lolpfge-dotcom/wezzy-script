--[[
    ...
    Full Feature Script with swimhub Design
    ...
    for _, player in pairs(Players:GetPlayers()) do
        if player ~= LocalPlayer and player.Character and player.Character:FindFirstChild("Head") then
            ...
            if onScreen then
                ...
                if distanceFromMouse < Config.Combat.Aimbot.FOV and distanceFromMouse < closestDistance then
...
RunService.RenderStepped:Connect(function()
    ...
    if Config.ESP.Player.Enabled and tick() % 5 < 0.1 then
        ScanForNPCs()
    end
...
print("-- [wezzy] All features loaded with swimhub design!")
